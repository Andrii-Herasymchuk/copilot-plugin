...
allowed-tools: mcp__suppa
---
Produce my daily standup using Suppa.

1. Resolve me with `suppa_get_me`.
2. Fetch my active work with `suppa_search_tasks` using `my=True, active=True`, and
   overdue items with `my=True, overdue=True`.
