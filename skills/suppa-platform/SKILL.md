---
name: suppa-platform
description: How to use the Suppa MCP tools (suppa_*) correctly for Tasks, Docs, Entities, and Forms. Load this when creating, searching, or updating Suppa tasks, comments, documents, pages, entities, records, or forms, or when a suppa_* tool returns an error or an empty result.
---
